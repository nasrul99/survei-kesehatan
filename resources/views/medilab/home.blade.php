    ...
    <section id="hero" class="hero section light-background">
        ...
        <div class="container position-relative">
            ...
            <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
                ...
                <p>Sistem Informasi Kesehatan Masyarakat</p>
            </div><!-- End Welcome -->

            <div class="content row gy-4">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
                        <h3 align="center">SISEHAT ?</h3>
                        <p align="center">
                            Sistem informasi kesehatan masyarakat (SISEHAT) yang dikembangkan, memiliki
                            peran penting dalam memantau kesehatan dan kondisi fisik masyarakat.
                            <br/><br/>
                            Dengan adanya sistem informasi ini, masyarakat dapat melakukan deteksi dini
                            terhadap
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box" data-aos="zoom-out" data-aos-delay="300">
                                    ...
                                    <p align="center">
                                        ...
                                        pengumpulan
                                        data pemeriksaan kesehatan rutin, pengolahan hasil skrining seperti: BMI, gula
                                        darah,
                            ...
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box" data-aos="zoom-out" data-aos-delay="400">
                                    ...
                                    <p align="center">
                                        ...
                                        untuk mengambil keputusan berbasis data terkait kesehatan masyarakat. SISEHAT
                                        menyediakan
                            ...
                            <div class="col-xl-4 d-flex align-items-stretch">
                                <div class="icon-box" data-aos="zoom-out" data-aos-delay="500">
                                    ...
                                    <h4>Manfaat</h4>
                                    <p align="center"> Dalam jangka panjang, SISEHAT berpotensi mengurangi biaya
