...
class PemeriksaanKolesterolChart extends ChartWidget
{
    protected static ?int $sort = 3;
    protected static ?string $heading = 'Grafik Pemeriksaan Kolesterol Total';
